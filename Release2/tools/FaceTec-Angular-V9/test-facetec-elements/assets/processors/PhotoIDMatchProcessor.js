...
var PhotoIDMatchProcessor = /** @class */ (function () {
    ...
    PhotoIDMatchProcessor.prototype.processSessionResultWhileFaceTecSDKWaits = function (sessionResult, faceScanResultCallback) {
        ...
        //
        this.latestNetworkRequest = new XMLHttpRequest();
        this.latestNetworkRequest.open("POST", Config_1.Config.BaseURL + "/enrollment-3d");
        ...
        this.latestNetworkRequest.setRequestHeader("X-User-Agent", FaceTecSDK_1.FaceTecSDK.createFaceTecAPIUserAgentString(sessionResult.sessionId));
    ...
    PhotoIDMatchProcessor.prototype.processIDScanResultWhileFaceTecSDKWaits = function (idScanResult, idScanResultCallback) {
        ...
        // In the code in your own App, you can pass around signals, flags, intermediates, and results however you would like.
        //
        this.sampleAppControllerReference.setLatestIDScanResult(idScanResult);
        //
        ...
        //
        this.latestNetworkRequest = new XMLHttpRequest();
        this.latestNetworkRequest.open("POST", Config_1.Config.BaseURL + "/match-3d-2d-idscan");
        this.latestNetworkRequest.setRequestHeader("Content-Type", "application/json");
        // TODO: Make this prettier and more consolidated and perhaps less things to do here.
        this.latestNetworkRequest.setRequestHeader("X-Device-Key", Config_1.Config.DeviceKeyIdentifier);
        this.latestNetworkRequest.setRequestHeader("X-User-Agent", FaceTecSDK_1.FaceTecSDK.createFaceTecAPIUserAgentString(idScanResult.sessionId));
        this.latestNetworkRequest.onreadystatechange = function () {
            //
            ...
            if (_this.latestNetworkRequest.readyState === XMLHttpRequest.DONE) {
                try {
                    ...
                    if (responseJSON.success === true) {
                        ...
                        _this.success = true;
                        // Demonstrates dynamically setting the Success Screen Message.
                        FaceTecSDK_1.FaceTecSDK.FaceTecCustomization.setOverrideResultScreenSuccessMessage("Your 3D Face\r\nMatched Your ID");
                        ...
                        // Attackers/Fraudsters will continue to get rejected.
                        console.log("User needs to retry, invoking retry.");
                        idScanResultCallback.retry(FaceTecSDK_1.FaceTecSDK.FaceTecIDScanRetryMode.Front, overrideMessage);
                    }
                    else {
                        // CASE:  UNEXPECTED response from API.  Our Sample Code keys of a success boolean on the root of the JSON object --> You define your own API contracts with yourself and may choose to do something different here based on the error.
                        console.log("Unexpected API response, cancelling out.");
...
//# sourceMappingURL=PhotoIDMatchProcessor.js.map