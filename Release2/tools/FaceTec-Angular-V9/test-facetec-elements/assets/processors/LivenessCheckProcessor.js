...
var FaceTecSDK_js_1 = require("../core-sdk/FaceTecSDK.js/FaceTecSDK.js");
//
...
var LivenessCheckProcessor = /** @class */ (function () {
    function LivenessCheckProcessor(sessionToken, sampleAppControllerReference) {
        ...
        //
        new FaceTecSDK_js_1.FaceTecSDK.FaceTecSession(this, sessionToken);
    }
    //
    // Part 2:  Handling the Result of a FaceScan
    //
    LivenessCheckProcessor.prototype.processSessionResultWhileFaceTecSDKWaits = function (sessionResult, faceScanResultCallback) {
        var _this = this;
        //
        // DEVELOPER NOTE:  These properties are for demonstration purposes only so the Sample App can get information about what is happening in the processor.
        // In the code in your own App, you can pass around signals, flags, intermediates, and results however you would like.
        ...
        //
        if (sessionResult.status !== FaceTecSDK_js_1.FaceTecSDK.FaceTecSessionStatus.SessionCompletedSuccessfully) {
            console.log("Session was not completed successfully, cancelling.  Status: " + sessionResult.status);
        ...
        //
        this.latestNetworkRequest = new XMLHttpRequest();
        this.latestNetworkRequest.open("POST", Config_1.Config.BaseURL + "/liveness-3d");
        ...
        this.latestNetworkRequest.setRequestHeader("X-Device-Key", Config_1.Config.DeviceKeyIdentifier);
        this.latestNetworkRequest.setRequestHeader("X-User-Agent", FaceTecSDK_js_1.FaceTecSDK.createFaceTecAPIUserAgentString(sessionResult.sessionId));
        this.latestNetworkRequest.onreadystatechange = function () {
            ...
            if (_this.latestNetworkRequest.readyState === XMLHttpRequest.DONE) {
                try {
                    ...
                    // In the code in your own App, you can pass around signals, flags, intermediates, and results however you would like.
                    //
                    _this.sampleAppControllerReference.setLatestServerResult(responseJSON);
                    if (responseJSON.success === true) {
                        ...
                        FaceTecSDK_js_1.FaceTecSDK.FaceTecCustomization.setOverrideResultScreenSuccessMessage("Liveness\nConfirmed");
    ...
    //
    LivenessCheckProcessor.prototype.onFaceTecSDKCompletelyDone = function () {
        //
    ...
    //
    LivenessCheckProcessor.prototype.isSuccess = function () {
        return this.success;
    };
    return LivenessCheckProcessor;
}());
exports.LivenessCheckProcessor = LivenessCheckProcessor;
//# sourceMappingURL=LivenessCheckProcessor.js.map