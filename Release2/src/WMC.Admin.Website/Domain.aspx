<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Domain.aspx.vb" Inherits="AdminDomainUser" %>
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <table style="width: 100%;" border="1">
            <tr>
                <td>
                    ...
                    <asp:GridView ID="GridView4" runat="server" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="Id" DataSourceID="SqlDataSourceCountry" ForeColor="#333333" GridLines="None">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="TrustValue" HeaderText="TrustValue" SortExpression="TrustValue" />
                            <asp:TemplateField HeaderText="AlphaSupport" SortExpression="AlphaSupport">
                                <EditItemTemplate>
                                    <asp:CheckBox ID="CheckBox1" runat="server" Checked='<%# Bind("AlphaSupport") %>' />
                                </EditItemTemplate>
                                <ItemTemplate>
                                    <asp:Label ID="Label1" runat="server" Text='<%# Bind("AlphaSupport") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                ...
                <td>
                    <asp:DetailsView ID="DetailsView4" runat="server" AutoGenerateRows="False" CellPadding="4" DataKeyNames="Id" DataSourceID="SqlDataSourceCountry" DefaultMode="Insert" ForeColor="#333333" GridLines="None" Height="50px" Width="125px">
                        <AlternatingRowStyle BackColor="White" />
            ...
            <tr>
                ...
                <td>
                    <asp:DetailsView ID="DetailsView8" runat="server" AutoGenerateRows="False" CellPadding="4" DataKeyNames="Id" DataSourceID="SqlDataSourceOrderStatus" DefaultMode="Insert" ForeColor="#333333" GridLines="None" Height="50px" Width="125px">
                        <AlternatingRowStyle BackColor="White" />
                        <CommandRowStyle BackColor="#FFFFC0" Font-Bold="True" />
                        <FieldHeaderStyle BackColor="#FFFF99" Font-Bold="True" />
                        <Fields>
        ...
        <asp:SqlDataSource ID="SqlDataSourceCountry" runat="server" ConnectionString="<%$ ConnectionStrings:LocalConnectionString %>" DeleteCommand="DELETE FROM [Country] WHERE [Id] = @Id" InsertCommand="INSERT INTO [Country] ([Code], [Text], [PhoneCode]) VALUES (@Code, @Text, @PhoneCode)" SelectCommand="SELECT Id, Code, Text, PhoneCode, CurrencyId, PhoneNumberStyle, CultureCode, TrustValue, AlphaSupport FROM Country ORDER BY Text" UpdateCommand="UPDATE Country SET Code = @Code, Text = @Text, PhoneCode = @PhoneCode, CurrencyId = @CurrencyId, PhoneNumberStyle = @PhoneNumberStyle, CultureCode = @CultureCode, TrustValue = @TrustValue, AlphaSupport = @AlphaSupport WHERE (Id = @Id)">
            <DeleteParameters>
                <asp:Parameter Name="Id" Type="Int32" />
            </DeleteParameters>
            <InsertParameters>
            ...
            <UpdateParameters>
                ...
                <asp:Parameter Name="TrustValue" Type="Decimal" />
                <asp:Parameter Name="AlphaSupport" Type="Boolean" />
                <asp:Parameter Name="Id" Type="Int32" />
            </UpdateParameters>
        </asp:SqlDataSource>
