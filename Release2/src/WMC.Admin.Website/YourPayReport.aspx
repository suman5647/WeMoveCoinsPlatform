<%@ Page Language="vb" MasterPageFile="~/MasterPageAdmin.master" AutoEventWireup="false" CodeFile="YourPayReport.aspx.vb" Inherits="YourPayReport" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="ajaxToolkit" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
  <asp:ScriptManager runat="server" EnableScriptLocalization="true" EnableScriptGlobalization="true">
  ...
  <script>
    ...
    <asp:DropDownList ID="DropDownListSite" runat="server" CssClass="searchTextBox">
        ...
        <asp:ListItem Value="15">SimpleKoin.com</asp:ListItem>
        <asp:ListItem Value="16">MyCoins</asp:ListItem>
        <asp:ListItem Value="20">CoinBox</asp:ListItem>
    </asp:DropDownList>
    &nbsp;
