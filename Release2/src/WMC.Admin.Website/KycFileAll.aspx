<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPageAdmin.master" AutoEventWireup="false" CodeFile="KycFileAll.aspx.vb" Inherits="KycFile" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <br />
    <br />
    <asp:GridView ID="GridViewUserToBeVerified" runat="server" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="Id" DataSourceID="SqlDataSourceKycUserAll" EmptyDataText="No users are currently waiting to be approved" ForeColor="#333333" GridLines="None" Width="595px" AllowPaging="True" PageSize="20">
    ...
    <br />--%>
    <br />
    KYC Files:<asp:GridView ID="GridViewKycFile" runat="server" AutoGenerateColumns="False" DataKeyNames="Id" DataSourceID="SqlDataSourceKycFileAll" AllowPaging="True" AllowSorting="True" CellPadding="3" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px">
        <Columns>
    ...
    <br />
    <asp:SqlDataSource ID="SqlDataSourceKycUserAll" runat="server" ConnectionString="<%$ ConnectionStrings:LocalConnectionString %>" SelectCommand="SELECT DISTINCT KycFile.UserId, [User].Fname, [User].Id, [User].Email, [User].Phone, [User].KycNote FROM KycFile INNER JOIN [User] ON KycFile.UserId = [User].Id ORDER BY KycFile.UserId DESC" UpdateCommand="UPDATE [User] SET KycNote = @KycNote WHERE (Id = @Id)">
        <UpdateParameters>
    ...
    <br />
    <asp:SqlDataSource ID="SqlDataSourceKycImage" runat="server" ConnectionString="<%$ ConnectionStrings:LocalConnectionString %>" SelectCommand="SELECT NULL as [File] ,Id FROM KycFile WHERE (Id = @Id)">
        <SelectParameters>
