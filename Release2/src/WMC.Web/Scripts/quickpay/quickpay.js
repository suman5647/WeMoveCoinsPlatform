window.QuickPay = window.QuickPay || {}, window.QuickPay.Embedded = window.QuickPay.Embedded || {},
    ...
    //Script to update datalayer when payment page for credit card is loaded
    dataLayer.push({
        'virtualPage': '/' + userLang + '/funnel/paymentCreditCard',
            ...
            var a = function (e, n) {
                ...
                m = function () {
                    var e = function (e, t) {
                        var n = new Date,
                            a = n.getMonth() + 1,
                            r = parseInt((n.getFullYear() + "").substr(2, 2), 10);
                ...
                y = function (t, n, a) {
                    ...
                    r.open("GET", e + "/payment-methods?bin=" + t), r.timeout = 3e4, r.setRequestHeader("Accept", "application/json"), r.onreadystatechange = function () {                            
                        if (r.status !== 200) { //Added new to display error message for invalid cards  (Added by Omkar on 2020-04-15)   
                            $('#showCCInvalidError').css('display', 'inherit');
                        }
                        if (4 === r.readyState) {
                ...
                b = function (e) {
                    ...
                    var n = e.brand,
                        a = e.country_alpha2,
                        r = t.selectedPaymentMethods.indexOf(n) >= 0;
    ...
    function (e) {
        ...
        t.Link = function (e, t) {
            ...
            var d = new XMLHttpRequest,
                u = o.base_url + "/embedded/v2/" + o.session + "/authorize",
                s = function (e) {
    ...
    function (e, t) {
        ...
        n.Form = function (e, a) {
            ...
            if (a.hasOwnProperty("base_url") && 0 !== a.base_url.length || (a.base_url = r.base_url), a.hasOwnProperty("payment_link")) r.link = new n.Link(a.base_url, a.payment_link);
            else {
            ...
            if (null === n && (null === a || null === r)) throw 'Unable to find form input field(s) with data-quickpay="expiration" or data-quickpay="exp-month" and data-quickpay="exp-year"';
            ...
            if (null === i) throw 'Unable to find form input field with data-quickpay="cvd"';
            ...
            //Added a new event SecureWindow into init (Added by Omkar on 2020-04-15)   
            ["init", "success", "failure", "beforeCreate", "brandChanged", "cardnumberChanged", "expirationChanged", "cvdChanged", "feeChanged", "paymentMethodChanged", "validChanged", "before3DSecure", "after3DSecure", "on3DsecureWindow"].forEach(function (t) {
            ...
            var n = this,
                ...
                d = function (e, t) {
                    n.fireEvent("failure", n, "authorize", t, {
                        status: e
                    })
                },
                u = function (a, r) {
                    if (n.fireEvent("before3DSecure", n, a)) {                        
                        ...
                        d.setAttribute("id", "quickpay_3dsecure_frame"), d.setAttribute("srcdoc", i), d.setAttribute("width", "100%"), d.setAttribute("height", "100%"); //Added new width and height values  (Added by Omkar on 2020-04-15) 
                        n.fireEvent("on3DsecureWindow", n, d); //Added new event to handle modal window   (Added by Omkar on 2020-04-15)   
                        var u = function (t) {
                            n.fireEvent("after3DSecure", n, t.data), e.removeEventListener("message", u, !1), r(t.data)
                        };
            ...
            if (t.eventListeners.hasOwnProperty(e))
                for (var r = t.eventListeners[e], i = 0; i < r.length && (n = n && r[i].apply(t, a) !== !1, n); i++);
            return n
            ...
            if (n && a) {
                var r = a.value,
                    i = n.value;
                return 0 === r.length || 0 === i.length ? null : {
                    month: a.value,
                    year: n.value
                }
            }
